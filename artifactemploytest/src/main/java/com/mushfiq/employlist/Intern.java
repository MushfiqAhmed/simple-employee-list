...
public class Intern extends Employee implements IPartTimer {


    /*****************************************************************
     * These field members are to calculate compensation.
     * We assume hours worked = weeks worked x 40 for interns
     ******************************************************************/
    ...
    public Intern(String name, int weeksWorked, double hourlyRate) {
        super(name);
   ...
   /*
   Methods to calculate compensation. For interns, it is simply hourly rate x hours worked, which itself is derived
   from weeks worked. Interns work 5x8 = 40 hours a week
    */
    ...
    public boolean calculateHoursWorked() {
        if (this.weeksWorked < 0) {
            ...
            this.hoursWorked = (this.getWeeksWorked() * 40);
            return true;
        }
    }
